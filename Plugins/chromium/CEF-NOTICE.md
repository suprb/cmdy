...
The optional Browser app edition uses CEF
...
- Browser-edition packaging seals the whole `Frameworks/` payload inside the
...
app edition or the source/ad-hoc Browser Extension.
